  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden login-bg">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] rounded-full opacity-5"
          style={{ background: 'radial-gradient(circle, hsl(43,85%,55%), transparent)' }} />
        <div className="absolute bottom-[-20%] left-[-10%] w-[500px] h-[500px] rounded-full opacity-5"
          style={{ background: 'radial-gradient(circle, hsl(43,85%,55%), transparent)' }} />
      </div>

      <div className="w-full max-w-5xl mx-4 grid lg:grid-cols-2 gap-0 overflow-hidden rounded-2xl shadow-2xl animate-fade-up"
        ...
        <div className="relative hidden lg:block">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8"
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-semibold tracking-[0.2em] uppercase text-white/70">Family Office</span>
            </div>
        ...
        <div className="flex flex-col justify-center p-10 lg:p-12"
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <p className="text-xs font-semibold tracking-[0.15em] uppercase" style={{ color: 'hsl(43,85%,55%)' }}>Private</p>
            ...
            <div className="flex gap-2 mt-3 flex-wrap">
              {['Property', 'Stocks', 'Crypto', 'Budget', 'Future Planning'].map((tag) => (
                <span key={tag} className="text-xs px-2 py-0.5 rounded-full border font-medium"
                  style={{ borderColor: 'rgba(196,165,90,0.3)', color: 'hsl(43,85%,65%)', background: 'rgba(196,165,90,0.05)' }}>
                  {tag}
                </span>
              ))}
            </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              style={{
                background: loading ? 'rgba(196,165,90,0.4)' : 'linear-gradient(135deg, hsl(43,85%,55%), hsl(43,70%,42%))',
                color: 'hsl(224,40%,8%)',
                border: 'none',
              }}
            >
